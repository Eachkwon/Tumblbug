...
public class S3ThumbnailService {
    ...
    public List<String> upload(List<MultipartFile> files) throws IOException {
        ...
        for (MultipartFile file : files) {
            ...
            Thumbnail thumbnail = new Thumbnail(fileName, s3Client.getUrl(bucket, fileName).toString());
    ...
    public void delete(String imgUrl) {
        Thumbnail thumbnail = thumbnailRepository.findImageByImgUrl(imgUrl);
        String imageFileName = thumbnail.getImgFileName();
